...
> *This project is an independent open-source library developed for the Android Termux environment. It is not officially affiliated with, endorsed by, or sponsored by the Termux project, stability.ai, or Google LLC.*
