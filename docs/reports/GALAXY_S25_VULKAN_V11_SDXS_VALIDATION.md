...
- `S25_V10_GGML_VULKAN=VERIFIED`
- `S25_V11_SDXS_VULKAN=VERIFIED`
...
- `PACKAGE_STATUS=EXPERIMENTAL_ADRENO_CANDIDATE_PREPARED`
- `PUBLISH_READY=FALSE`
...
- **Branch**: `validation/galaxy-a35`
- **Commit**: `8410b1a5522fb040e36ae93772e88e1aab842a59`
- **Worktree Dirty**: `TRUE` (Local CLI patch applied and tested)
- **Pytest Results**: `54 passed in 3.33s` (`PYTEST_TOTAL=54`, `PYTEST_PASSED=54`, `PYTEST_FAILED=0`)
