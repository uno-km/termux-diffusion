...
DEFAULT_PRESETS = MappingProxyType({
    ...
    "counterfeit-v3-lcm": {
        "repo_id": "mzwing/Anything-LCM-GGUF",
        "filename": "anything_v30-LCM.q4_0.gguf",
        "alias": "counterfeit-v3-lcm.gguf",
        "description": "Counterfeit / Anime LCM (Q4_0) - High-quality 4~6 step Anime & Illustration generation",
        "size_mb": 1566,
        "default_steps": 6,
        "default_cfg": 1.5,
        "default_sampler": "lcm",
    ...
    "anything-v5-lcm": {
        "repo_id": "mzwing/Anything-LCM-GGUF",
        "filename": "anything_v30-LCM.q4_0.gguf",
        "alias": "anything-v5-lcm.gguf",
        "description": "Anything V5 / V3 LCM (Q4_0) - 4~6 step Stylized Anime art",
        "size_mb": 1566,
        "default_steps": 6,
        "default_cfg": 1.5,
        "default_sampler": "lcm",
    ...
    "ghostmix-lcm": {
        "repo_id": "void-gryph/ghostmix-GGUF",
        "filename": "ghostmix.Q4_K_M.gguf",
        "alias": "ghostmix.gguf",
        "description": "GhostMix (Q4_K_M) - 2.5D Semi-realistic Anime illustration",
        "size_mb": 484,
        "default_steps": 15,
        "default_cfg": 6.0,
    },
    "cyberrealistic-lcm": {
        "repo_id": "void-gryph/cyberrealistic-GGUF",
        "filename": "cyberrealistic.Q4_K_M.gguf",
        "alias": "cyberrealistic.gguf",
        "description": "CyberRealistic (Q4_K_M) - High-detail photorealistic portraits",
        "size_mb": 484,
        "default_steps": 15,
        "default_cfg": 6.0,
    },
    "bk-sdm-tiny": {
        ...
        "filename": "sdxs-512-tinySDdistilled_Q8_0.gguf",
        "alias": "sdxs.gguf",
        "description": "BK-SDM Tiny Fallback (SDXS Distilled Q8_0) - Ultra-lightweight on-device diffusion",
        "size_mb": 651,
        "default_steps": 1,
        "default_cfg": 1.0,
    },
